defmodule EducatiumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EducatiumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EducatiumWeb.Gettext, "errors", msg, opts)
    end
  end
